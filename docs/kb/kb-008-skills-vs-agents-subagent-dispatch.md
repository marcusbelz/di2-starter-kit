# KB-008: Skills vs. agents — and how subagent dispatch works

> Concept article — the sibling of [KB-007](kb-007-how-rules-and-skills-are-loaded.md). KB-007
...
## Related
- [KB-007](kb-007-how-rules-and-skills-are-loaded.md) — how rules and skills are loaded (auto-load vs. on-demand); this article extends that picture by the agents axis.
