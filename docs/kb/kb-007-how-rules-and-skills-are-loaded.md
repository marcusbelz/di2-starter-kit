# KB-007: How rules and skills are loaded (auto-load vs. on-demand)
...
[KB-008](kb-008-skills-vs-agents-subagent-dispatch.md)) reuse the identical wording
...
## Related
- [KB-008](kb-008-skills-vs-agents-subagent-dispatch.md) — skills vs. **agents** (`.claude/agents/`) and how subagent dispatch works; extends this picture by the third `.claude/` citizen.
